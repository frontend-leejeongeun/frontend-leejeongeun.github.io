...
- [MobX](https://mobx.js.org/README.html)를 사용하면서 느낀점은 '간단하고 쉽지는 않다' 였습니다. 동작 원리를 이해하고 작성해보고 적용해나가기까지 꽤나 고군분투 했습니다. 지금도 수정하고 리팩토링해야할 부분이 많지만 한번에 만족하기보다 이후에 차차로 리팩토링 해나가며 심도있게 학습할 예정입니다.
...
5.  다만 단점으로는 리액트는 처음에는 러닝커브가 있다는 점입니다. 그 예로 MobX, Redux, NextJS 등 작동 원리와 코드 작성 방식 등을 이해하고 익혀야 한다는 알면 알수록 학습적인 그러나 매력적인 프레임워크라는 점을 느꼈습니다.
